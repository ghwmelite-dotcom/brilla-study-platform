...
async function syncAnswers() {
  // Get pending answers from IndexedDB and sync
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    body: data.body || 'New notification from Brilla',
  ...
  event.waitUntil(
    self.registration.showNotification(data.title || 'Brilla', options)
  );
});
