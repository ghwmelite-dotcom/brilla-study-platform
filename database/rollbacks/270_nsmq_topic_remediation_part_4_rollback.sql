...
CREATE TABLE IF NOT EXISTS _rollback_270_expected(q TEXT PRIMARY KEY,s TEXT NOT NULL,r TEXT NOT NULL,t TEXT);
...
INSERT INTO _rollback_270_expected
...
SELECT CASE WHEN
  ...
  AND NOT EXISTS (SELECT 1 FROM _rollback_270_expected WHERE t IS NULL)
