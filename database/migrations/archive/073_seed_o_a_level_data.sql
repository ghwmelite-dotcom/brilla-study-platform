-- Migration: Seed O-Level and A-Level Initial Data
...
-- =============================================
-- SEED SUBJECT CATEGORIES FOR O/A LEVELS
-- =============================================

INSERT OR IGNORE INTO subject_categories (id, exam_type_id, name, slug, description, is_core, display_order) VALUES
-- Cambridge IGCSE Categories
('cat_igcse_sciences', 'igcse', 'Sciences', 'sciences', 'Science subjects including Physics, Chemistry, Biology', 0, 1),
('cat_igcse_mathematics', 'igcse', 'Mathematics', 'mathematics', 'Mathematics and Additional Mathematics', 0, 2),
('cat_igcse_languages', 'igcse', 'Languages', 'languages', 'English and other languages', 0, 3),

-- Cambridge A-Level Categories
('cat_alevel_sciences', 'cambridge_a2', 'Sciences', 'sciences', 'A-Level Science subjects', 0, 1),
('cat_alevel_mathematics', 'cambridge_a2', 'Mathematics', 'mathematics', 'A-Level Mathematics subjects', 0, 2),

-- Edexcel IGCSE Categories
('cat_edexcel_igcse_sciences', 'edexcel_igcse', 'Sciences', 'sciences', 'Edexcel IGCSE Science subjects', 0, 1),
('cat_edexcel_igcse_mathematics', 'edexcel_igcse', 'Mathematics', 'mathematics', 'Edexcel IGCSE Mathematics', 0, 2);

-- =============================================
-- SEED SUBJECTS FOR CAMBRIDGE IGCSE (STEM)
-- =============================================

INSERT OR IGNORE INTO subjects (id, name, slug, icon, color, description, display_order, exam_type_id, category_id, is_active) VALUES
-- Cambridge IGCSE Sciences
('subj_igcse_physics', 'Physics', 'igcse-physics', 'atom', '#3B82F6', 'Cambridge IGCSE Physics (0625)', 1, 'igcse', 'cat_igcse_sciences', 1),
('subj_igcse_chemistry', 'Chemistry', 'igcse-chemistry', 'flask-conical', '#10B981', 'Cambridge IGCSE Chemistry (0620)', 2, 'igcse', 'cat_igcse_sciences', 1),
('subj_igcse_biology', 'Biology', 'igcse-biology', 'leaf', '#22C55E', 'Cambridge IGCSE Biology (0610)', 3, 'igcse', 'cat_igcse_sciences', 1),

-- Cambridge IGCSE Mathematics
('subj_igcse_math', 'Mathematics', 'igcse-mathematics', 'calculator', '#8B5CF6', 'Cambridge IGCSE Mathematics (0580)', 1, 'igcse', 'cat_igcse_mathematics', 1),
('subj_igcse_add_math', 'Additional Mathematics', 'igcse-add-math', 'sigma', '#EC4899', 'Cambridge IGCSE Additional Mathematics (0606)', 2, 'igcse', 'cat_igcse_mathematics', 1);

-- =============================================
-- SEED SUBJECTS FOR CAMBRIDGE A-LEVEL (STEM)
-- =============================================

INSERT OR IGNORE INTO subjects (id, name, slug, icon, color, description, display_order, exam_type_id, category_id, is_active) VALUES
-- Cambridge A-Level Sciences
('subj_alevel_physics', 'Physics', 'alevel-physics', 'atom', '#2563EB', 'Cambridge International A Level Physics (9702)', 1, 'cambridge_a2', 'cat_alevel_sciences', 1),
('subj_alevel_chemistry', 'Chemistry', 'alevel-chemistry', 'flask-conical', '#059669', 'Cambridge International A Level Chemistry (9701)', 2, 'cambridge_a2', 'cat_alevel_sciences', 1),
('subj_alevel_biology', 'Biology', 'alevel-biology', 'leaf', '#16A34A', 'Cambridge International A Level Biology (9700)', 3, 'cambridge_a2', 'cat_alevel_sciences', 1),

-- Cambridge A-Level Mathematics
('subj_alevel_math', 'Mathematics', 'alevel-mathematics', 'calculator', '#7C3AED', 'Cambridge International A Level Mathematics (9709)', 1, 'cambridge_a2', 'cat_alevel_mathematics', 1),
('subj_alevel_further_math', 'Further Mathematics', 'alevel-further-math', 'sigma', '#DB2777', 'Cambridge International A Level Further Mathematics (9231)', 2, 'cambridge_a2', 'cat_alevel_mathematics', 1);

-- =============================================
-- SEED SUBJECTS FOR EDEXCEL IGCSE (STEM)
-- =============================================

INSERT OR IGNORE INTO subjects (id, name, slug, icon, color, description, display_order, exam_type_id, category_id, is_active) VALUES
('subj_edexcel_igcse_physics', 'Physics', 'edexcel-igcse-physics', 'atom', '#0284C7', 'Edexcel International GCSE Physics (4PH1)', 1, 'edexcel_igcse', 'cat_edexcel_igcse_sciences', 1),
('subj_edexcel_igcse_chemistry', 'Chemistry', 'edexcel-igcse-chemistry', 'flask-conical', '#047857', 'Edexcel International GCSE Chemistry (4CH1)', 2, 'edexcel_igcse', 'cat_edexcel_igcse_sciences', 1),
('subj_edexcel_igcse_biology', 'Biology', 'edexcel-igcse-biology', 'leaf', '#15803D', 'Edexcel International GCSE Biology (4BI1)', 3, 'edexcel_igcse', 'cat_edexcel_igcse_sciences', 1),
('subj_edexcel_igcse_math', 'Mathematics A', 'edexcel-igcse-math', 'calculator', '#6D28D9', 'Edexcel International GCSE Mathematics A (4MA1)', 1, 'edexcel_igcse', 'cat_edexcel_igcse_mathematics', 1);
