...
CREATE TABLE IF NOT EXISTS _nsmq_legacy_278_expected(q TEXT PRIMARY KEY,s TEXT NOT NULL,r TEXT NOT NULL,k TEXT NOT NULL,t TEXT);
...
INSERT INTO _nsmq_legacy_278_expected
