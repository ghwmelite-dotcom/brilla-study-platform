...
CREATE TABLE IF NOT EXISTS _migration_267_expected(q TEXT PRIMARY KEY,s TEXT NOT NULL,r TEXT NOT NULL,t TEXT);
...
INSERT INTO _migration_267_expected
...
SELECT CASE WHEN
  ...
  AND NOT EXISTS (SELECT 1 FROM _migration_267_expected WHERE t IS NULL)
