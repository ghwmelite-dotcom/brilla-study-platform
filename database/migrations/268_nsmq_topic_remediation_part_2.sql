...
CREATE TABLE IF NOT EXISTS _migration_268_expected(q TEXT PRIMARY KEY,s TEXT NOT NULL,r TEXT NOT NULL,t TEXT NOT NULL);
DELETE FROM _migration_268_expected;
INSERT INTO _migration_268_expected VALUES
...
SELECT CASE WHEN
  ...
  AND NOT EXISTS (SELECT 1 FROM _migration_268_expected e LEFT JOIN topics t ON t.id=e.t WHERE
