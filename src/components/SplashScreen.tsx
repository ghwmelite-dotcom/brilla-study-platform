        ...
        >
          <style>{`
            ...
            .splash-screen {
              ...
              background:
                radial-gradient(ellipse 80% 50% at 50% 0%, rgba(124, 58, 237, 0.15) 0%, transparent 50%),
                radial-gradient(ellipse 60% 40% at 80% 100%, rgba(139, 92, 246, 0.1) 0%, transparent 50%),
                radial-gradient(ellipse 50% 30% at 10% 60%, rgba(168, 85, 247, 0.08) 0%, transparent 50%),
                linear-gradient(180deg, #050208 0%, #0a0618 30%, #110a24 70%, #0d0714 100%);
              overflow: hidden;
            ...
            .splash-screen::before {
              ...
              background-image:
                ...
                radial-gradient(1.5px 1.5px at 90px 40px, rgba(251,191,36,0.4), transparent),
                radial-gradient(1px 1px at 130px 80px, rgba(255,255,255,0.3), transparent),
                radial-gradient(1.2px 1.2px at 160px 120px, rgba(255,255,255,0.2), transparent);
          ...
          <div className="orbit-container">
            {particles.map(particle => (
              <div
                key={particle.id}
                className={`orbital-particle ${particle.isGold ? 'gold' : 'violet'}`}
                style={{
          ...
          >
            <div className="star-logo">
              ...
              <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Inner accent */}
                <path
                  d="M50 20 L56 38 L75 38 L60 50 L66 70 L50 58 L34 70 L40 50 L25 38 L44 38 Z"
                  fill="url(#starGradient2)"
                  opacity="0.6"
                />
                {/* Center circle */}
                <circle cx="50" cy="45" r="8" fill="#faf5ff" opacity="0.9" />
              </svg>
            </div>
